...
RUN apt-get update && apt-get -y install supervisor postfix rsyslog postgrey maildrop postfix-policyd-spf-perl postfix-mysql spamass-milter dovecot-imapd vim net-tools patch
